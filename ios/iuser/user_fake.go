...
// counterfeiter -o ios/iuser/user_fake.go --fake-name UserFake ios/iuser/user.go User
...
//Current ...
func (fake *UserFake) Current() (*user.User, error) {
...
//CurrentCallCount ...
func (fake *UserFake) CurrentCallCount() int {
...
//CurrentReturns ...
func (fake *UserFake) CurrentReturns(result1 *user.User, result2 error) {
